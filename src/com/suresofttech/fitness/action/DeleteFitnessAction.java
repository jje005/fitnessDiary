...
public class DeleteFitnessAction extends Action implements ISelectionListener, IWorkbenchAction {
	private final static String ID = "com.suresofttech.fitness.action.deleteFitnessAction";
	private final IWorkbenchWindow window;
	private IStructuredSelection selection;
	
	public DeleteFitnessAction(IWorkbenchWindow iwindow){
        this.window = iwindow;
    ...
    public void deleteFitnessEntry(FitnessEntry entry) {
        if(entry != null){
